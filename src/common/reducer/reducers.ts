...
import { getMindPop, listState, listCount, selectedItemCount } from '../../views/mindPop/list/reducer';
...
const reducers = combineReducers({
    loginStatus, getMindPop,
    addMindPop, mindPopEditMode: editScreenMode,
    mindPopListSelectionStatus: listState, listCount,
    selectedItemCount, deleteMindPop,
    intanceList, requestInstances, account,
    forgotPassword, MemoryInitials,
    NotificationsRedux, dashboardReducer
})
