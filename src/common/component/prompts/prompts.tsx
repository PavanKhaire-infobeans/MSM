...
import { TouchableHighlight, ViewStyle, Platform, View, Dimensions } from 'react-native';
    ...
    get pagination () {
      ...
      return (
          <Pagination
            ...
            containerStyle={{ backgroundColor: "transparent", marginTop: -35, marginBottom: -15}}
            dotStyle={{
                width: 10,
                height: 10,
                borderRadius: 5,
    ...
    render() {
      return <View>
        <Carousel	
            ...
            renderItem={(item : any ) => 
              <View style={{width: '100%', padding: 16, paddingTop: 0, alignItems: 'center', height: 100, justifyContent: 'center'}}>
                <Text style={{margin: 1, textAlign: 'center', ...fontSize(22), color: '#fff'}} numberOfLines={3}>{item.item?.prompt_title}</Text>
              </View>
            }
            ...
            <TouchableHighlight underlayColor={'none'} onPress={()=> {              
              ...
              if(this.state.activeIndex == this.props.data.length-1 && this.state.activeIndex != 0){
                this.setState({activeIndex : this.state.activeIndex - 1})
              }
            }
            }>
              <View style={{width: 200,padding: 10, borderRadius: 50, borderColor: '#fff', borderWidth: 1, alignItems: 'center', justifyContent: 'center', alignSelf : 'center'}}>
                <Text style={{...fontSize(18), color: '#fff', fontWeight: "400"}}>Add your memory</Text>
              </View>
            </TouchableHighlight>
      </View>
    }    
