    ...
    _renderRight() {
        return (
            <View style={[styles.rightButtonsContainer]}>
                {this.props.showRightText && <TouchableOpacity onPress={() => this.props.saveValues()}
                    style={styles.rightButtonsTouchable}>
                    <Text style={{ ...fontSize(16), fontWeight: Platform.OS === "ios"? '500':'bold', color: "#fff", paddingRight : 10 }}>{this.props.rightText}</Text>
                </TouchableOpacity>}
