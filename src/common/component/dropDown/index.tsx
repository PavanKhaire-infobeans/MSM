...
import { View, Animated, Platform, TouchableHighlight, Picker } from "react-native";
		...
		return (
			<View style={[this.props.style, { flexDirection: 'column'}]}>
				<View style={{ flex: 1, justifyContent: "center", minWidth: 150 }}>
					<TouchableHighlight underlayColor="#cccccc3e" onPress={this.showPicker}>
						<Animated.View
							style={{
								...
								borderWidth: 1 , 
								borderColor: this.props.showError ? Colors.NewRadColor : this.props.isCuebackRegistration ? Colors.TextColor : "transparent"
							}}>
							<View style={[this.props.inputViewStyle]}>
								<Animated.Text
									style={{
										color: this.props.isCuebackRegistration ? Colors.TextColor: selectedValue.length > 0 ? Colors.NewTitleColor : this.props.placeholderTextColor,
										...fontSize(13),
										fontFamily: "Rubik",
										position: "absolute",
										top: kTopAnimated,
								...
								<Text style={[{ left: 0, fontFamily: "Rubik", top: 12, ...fontSize(18), height: "70%", color: this.props.isCuebackRegistration ? Colors.TextColor : Colors.TextColor, lineHeight: 35, letterSpacing: -0.1, paddingRight: 20 }]}>
									{selectedValue}
								</Text>
							</View>
							<View style={{position: "absolute", right: 15, alignSelf: 'center', height: 5, width: 10, borderTopWidth: 5, borderBottomWidth: 0, borderRightWidth: 5, borderLeftWidth: 5, borderColor: 'transparent', borderTopColor: this.props.isCuebackRegistration ? Colors.TextColor: "rgba(0, 0, 0, 0.54)" }} />
						</Animated.View>
					</TouchableHighlight>
				</View>
				<Animated.View
