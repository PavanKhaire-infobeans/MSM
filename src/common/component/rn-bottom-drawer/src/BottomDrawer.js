  ...
  render() {   
    return (
      <Animator
        ...
        onExpanded = {() => this.props.onExpanded(this.props.identifier)}
        onCollapsed = {() => this.props.onCollapsed(this.props.identifier)}
        drawerTapped = {() => this.props.drawerTapped(this.props.identifier)}
        responseRelease = {(e, guesture, direction)=> this.props.responseRelease(e, guesture, this.props.identifier, direction)}
        panResponderMove = {(e, guesture, direction)=> this.props.panResponderMove(e, guesture, this.props.identifier, direction)}>          
        {this.props.children}
