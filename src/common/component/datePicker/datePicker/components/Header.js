  ...
  return (
    <View style={[style.container, I18nManager.isRTL && style.reverseContainer]}>
      ...
      <TouchableOpacity
        ...
        style={[style.arrowWrapper,{marginRight:16}]}>
        <Image
          resizeMode='contain'
          source={require('../../assets/arrow.png')}
          style={[style.arsmallArrowrow, nextDisable && style.disableArrow]}
        />
      </TouchableOpacity>
        ...
        <Animated.View
          ...
          <TouchableOpacity
            ...
            <Image
              resizeMode='contain'
              source={require('../../assets/arrow.png')}
              style={[style.smallArrow, nextDisable && style.disableArrow]}
            />
          </TouchableOpacity>
          {/* {mode === 'datepicker' && (
            <TouchableOpacity
