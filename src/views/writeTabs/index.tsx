...
class WriteTabs extends React.Component<Props> {
  ...
  onFilterClick = () => {
    this.setState({currentScreen: this.screen}, () => {
      this.props.navigation.push('filtersScreen', {currentScreen: this.screen});
    });
  };
          ...
          <View style={Styles.fullFlex}>
            ...
            <ScrollableTabViewForWrite
              ...
              currentScreen={(screenName: any) => {
                ...
                if (screenName == 1) {
                  if (
                    this.props.navigation.currentScene != 'createMemory' &&
                    this.props.navigation.currentScene != 'mindPopList' &&
                    this.props.navigation.currentScene != 'addContent' &&
                    this.props.navigation.currentScene != 'dashboard'
                  ) {
                    this.props.navigation.push('addContent', {
                      beforeBack: () => {
                        this.setScreen();
