                    ...
                    <View style={Styles.fullFlex}>
                        ...
                        <ScrollableTabViewForWrite
                            ...
                            currentScreen={(screenName: any) => {
                                // alert(screenName)
                                if (screenName == 1) {
                                    if (this.props?.navigation?.state?.routeName != 'createMemory' && this.props?.navigation?.state?.routeName != 'mindPopList' && this.props?.navigation?.state?.routeName != 'addContent' && this.props?.navigation?.state?.routeName != 'dashboard') {
                                        this.props.navigation.navigate('addContent', {
                                ...
                                if (screenName == 2) {
                                    if(this.props?.navigation?.state?.routeName === 'myAccount'){
                                        this.setScreen()
                                    }
                                }
                            }}
