...
class NotificationView extends React.Component<Props> {
    ...
    constructor(props: Props) {
        super(props);  
        this.notificationListener = EventManager.addListener(NotificationListener, this.updateListing);
   ...
   // componentWillReceiveProps(props: Props){
    ...
    navigateToNotificationListing=(item : any)=>{
        Actions.push('notificationListing', {heading : item.item.group_name, index : item.index})
    }
                ...
                <FlatList
                    ...
                    renderItem={(item: any) => {
                            return (
                              ...
                              onPress= {() => this.navigateToNotificationListing(item)}></DefaultListItem>
                            )
                        }}
                        />
                        </View>
...
const mapDispatch = (dispatch: Function) => {
	return {
        ...
        setCurrentList : (payload : any) => dispatch({type: CurrentList, payload : payload}),
