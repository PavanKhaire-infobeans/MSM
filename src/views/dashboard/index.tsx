...
import { SafeAreaView, TouchableOpacity,   NativeModules, NativeEventEmitter, requireNativeComponent, UIManager, Platform,
    View, Dimensions, Alert,DeviceEventEmitter, StatusBar,  Keyboard} from "react-native";
	
import NetInfo from "@react-native-community/netinfo";
import Text from '../../common/component/Text'
import { connect } from 'react-redux';
import { fontSize, Storage, encode_utf8 , MemoryActionKeys, getValue, keyInt, getDetails, decode_utf8} from '../../common/constants';
...
import { delete_memory, edit_memory, move_to_draft, remove_me_from_this_post, block_memory, cancelActions, block_user, report_user, block_and_report
} from '../../images';
...
import {  MemoryAction,  kMemoryActionPerformedOnTimeline, kUpdateMemoryOnTimeline , kUpdateMemoryOnPublised} from '../myMemories/myMemoriesWebService';
import { GetActivities, kGetInvidualNotification, SetSeenActivity, kForegroundNotice, kActivityListener, kForegroundNotificationListener, kBackgroundNotice } from '../notificationView/notificationServices';
