...
import { ActivityIndicator, FlatList, Keyboard, Platform, RefreshControl, SafeAreaView, Text, TouchableOpacity, View } from "react-native";
...
const Recent = (props: Props) => {
    ...
    const promptToMemoryCallBack = (success: boolean, draftDetails: any) => {
        ...
        if (success) {
            ...
            navigation.navigate("createMemory", { editMode: true, draftNid: draftDetails, isFromPrompt: true })
        }
        else {
            loaderHandler.hideLoader()
