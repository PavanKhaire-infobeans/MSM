...
import { View, Image, StatusBar, NativeEventEmitter, NativeModules, Alert, DeviceEventEmitter, ImageBackground } from "react-native";
import Text from "../../common/component/Text";
import { splashText, msm_banner_white, msm_coloured_banner, splash_bg } from "../../images";
...
class Splash extends Component<Props> {
	...
	componentWillReceiveProps(nextProps: Props) {
		if (nextProps.user.instanceID != 0 && nextProps.user.userAuthToken != null) {
			Account.selectedData().values = nextProps.user;
			// Actions.reset("dashboardIndex")
			Actions.dashBoard();
		} else if (
			(nextProps.user.instanceID != 0 && (nextProps.user.userAuthToken == null || nextProps.user.userAuthToken.length == 0)) ||
	...
	render() {
		...
		return (
			...
			<ImageBackground source={splash_bg} style={{flex: 1, width: "100%", height: "100%"}}>
				...
				<View style={{ position: "absolute", bottom: 15, alignItems: "center", width: "100%", flexDirection: "column", justifyContent: "flex-end" }}>
