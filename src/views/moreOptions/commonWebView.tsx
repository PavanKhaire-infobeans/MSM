import { View, SafeAreaView, StatusBar, ScrollView, Image, TouchableOpacity, TextInput, KeyboardAvoidingView, Platform, Keyboard, Alert, ActivityIndicator } from "react-native";
            ...
            <View style={{flex: 1}}>
				<SafeAreaView style={{width: "100%", flex: 0, backgroundColor : Colors.NewThemeColor}}/>                   
                 ...
                 <WebView       
                     ...
                     injectedJavaScript={"document.cookie = 'show_hide_header_footer="+true+"; path=/'"}
                     />
                     <View style={{width: "100%", position : "absolute", top: 0}}>
                         <NavigationHeaderSafeArea 
                            backgroundColor={Colors.NewThemeColor} hideClose={false} 
                            heading={this.props.title} cancelAction={() => {Keyboard.dismiss(); Actions.pop()}} />
                    </View>
                     </View>
            </SafeAreaView>
            </View>
