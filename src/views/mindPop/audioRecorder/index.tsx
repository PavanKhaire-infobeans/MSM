...
export default class AudioRecorderView extends React.Component<
  Props & Upload,
  {} | State
> {
  // state = {
  ...
  // 	super(props);
  // 	this.isRecordingFromAddContent = this.props.recordingFromAddContent ? true : false;
  // 	AppState.addEventListener("change", this.isBackground);
  // 	if (this.props.selectedItem) {
  // 		this.state = { ...this.state, audioState: "recorded", path: this.props.selectedItem.uri || this.props.selectedItem.filePath };
  // 	}
  // }
  ...
  // 		this.setState({ error: { errMsg: "Only alphanumeric characters & '-' is allowed", show: true } });
  // 		return;
  // 	}
  ...
  // 							</TouchableOpacity>
  // 						</View>
  // 						<View style={{ height: 80, width: "100%", flexDirection: "row", padding: 10 }}>
  // 							<View style={{ width: "84%" }}>
  // 								<TextInput
  ...
  // 								) : null}
  // 							</View>
  // 							<View style={{ alignItems: "center", marginLeft: 6, height: 45, justifyContent: "center" }}>
