		...
		return (
			<View style={Styles.flexContainer}>
				...
				<View style={{ flex: 1, backgroundColor: Colors.NewThemeColor }}>
					...
					<ImageBackground source={Rectangle} resizeMode="stretch" style={{ height: Utility.getDeviceHeight() * 1, width: Utility.getDeviceWidth() * 1, justifyContent: "center" }}>
						<LinearGradient
									...
									{this.state.isRegistrationOpen ?
										...
										<View>
											...
											<View style={Styles.prologSubContainerStyle}>
												{Platform.OS == "ios" && (Platform.Version >= 13 || Platform.Version >= "13") &&
													<TouchableHighlight underlayColor={"#ffffff00"} onPress={() => { EventManager.callBack(kRegSignUp, loginType.appleLogin) }}>
														<View style={Styles.loginSSOButtonStyle}>
															<Image source={apple} />
															<Text style={[CommonTextStyles.fontWeight400Size19Inter, Styles.ssoTextStyle]}>Continue with Apple</Text>
														</View>
													</TouchableHighlight>
												}
												<View style={Styles.separatorHeightStyle32} />

												<TouchableHighlight underlayColor={"#ffffff00"} onPress={() => { EventManager.callBack(kRegSignUp, loginType.googleLogin) }}>
													<View style={Styles.loginSSOButtonStyle}>
														<Image source={google} />
														<Text style={[CommonTextStyles.fontWeight400Size19Inter, Styles.ssoTextStyle]}>Continue with Google</Text>
													</View>
												</TouchableHighlight>
												...
												<TouchableHighlight underlayColor={"#ffffff00"} onPress={() => this.joinPressed()}>
													<View style={[Styles.loginSSOButtonStyle, { backgroundColor: Colors.decadeFilterBorder }]}>
														{/* <Image source={icon_mail} style={{ height: 14, width: 20, resizeMode: "cover", tintColor: "#5c5c5c" }} /> */}
														<Text style={[CommonTextStyles.fontWeight400Size19Inter, Styles.ssoTextStyle, { color: Colors.white }]}>Create an account</Text>
													</View>
												</TouchableHighlight>
