...
export const MemoryInitials = (state = initialState, action: Payload) => {
    ...
    switch(action.type){       
        case ResetLocation : newState.locationList = [];
            break;
        case ResetALL : newState  = initialState;
            break;    
        case LocationListUpdated : newState.locationList = action.payload; 
            break;   
        case SaveNid : newState.nid = action.payload; 
            break    
        case MemoryInitialsUpdate : newState.title = action.payload.title;
                                    newState.date = {year: action.payload.memory_date.year, 
            ...
            break;     
        case RecentTags : newState.recentTags = action.payload;
            break;
        case SaveSearchList : newState.searchList = action.payload;
            break;                                              
        case SaveMemoryTagsList : newState.tags = action.payload;
            break;
        case SaveWhoElseWhereThere : newState.whoElseWhereThere = action.payload;
            break;        
        case CollectionList : newState.collectionList = action.payload;
            break;
        case SaveCollection : newState.collections = action.payload;
            break;     
        case SaveShareOption : newState.shareOption = action.payload;
            break;          
        case SaveCollaborators : newState.collaborators = action.payload.users.concat(action.payload.groups);
            break;
        case SaveAttachedFile : newState.files = action.payload;
            break;
        case SaveWhoCanSeeIds : newState.whoCanSeeMemoryUids = action.payload.userIds;
                                newState.whoCanSeeMemoryGroupIds = action.payload.groupIds;
            break;    
        case SaveCollaboratorNotes : newState.notesToCollaborators = action.payload;
            break;
        case SaveDescription : newState.description = action.payload;
            break;
        case EditContent : newState = action.payload;
            break;
    }
    return newState
}
