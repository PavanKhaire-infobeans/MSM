...
import { pdf_icon, add_icon, radio, radio_active, settings_icon, checkbox_active, checkbox } from "../../../images";
import { connect } from "react-redux";
import { LocationAPI, MemoryTagsAPI, CollectinAPI, MemoryCollectionsAPI } from "../saga";
...
const mapDispatch = (dispatch: Function) => {
	return {		
     ...
     //   MemoryCollectionsAPI : (payload: any) => dispatch({type: MemoryCollectionsAPI, payload : payload}),
        setCollection : (payload: any) => dispatch({type: SaveCollection, payload : payload})
	};
};
