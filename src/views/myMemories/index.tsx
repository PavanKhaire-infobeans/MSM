...
import { SafeAreaView, StyleSheet , View, StatusBar, Alert, Platform} from "react-native";
import Text from "../../common/component/Text";
// @ts-ignore
import ScrollableTabView from "../../common/component/ScrollableTabView";
import { Colors,MyMemoriesTapBarOptions, fontSize} from '../../common/constants';
    ...
    render() {
        return (
          ...
          <SafeAreaView style={{width: "100%", flex: 0, backgroundColor : Colors.NewThemeColor}}/>                   
            <SafeAreaView style={{width: "100%", flex: 111111111111111, backgroundColor : "#fff"}}>    
                      <View style={{flex: 1}}>
